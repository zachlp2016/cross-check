...
class SeasonStatisticsTest < Minitest::Test
  ...
  def test_worst_coach
   ...
   assert_equal "Paul Maurice", @stat_tracker.worst_coach("20172018")
 end

 def test_winningest_coach
   assert_equal "Darryl Sutter", @stat_tracker.winningest_coach("20132014")
   assert_equal "s", @stat_tracker.winningest_coach("20142015")
   assert_equal "s", @stat_tracker.winningest_coach("20172018")
 end
end
